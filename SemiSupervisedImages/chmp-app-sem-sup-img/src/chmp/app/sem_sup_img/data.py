...
def input_fn(data_fnames, batch_size, n_epochs=None):
    generate, types, shapes = make_input_generator(data_fnames, batch_size)
...
def make_input_generator(data_fnames, batch_size):
